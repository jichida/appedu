...
dbPartentscommunity = new Mongo.Collection('partentscommunity');//家长圈
dbPartentsletterssend = new Mongo.Collection('partentsletterssend');//家长信（发送）
dbPartentslettersrecv = new Mongo.Collection('partentslettersrecv');//家长信（接受）
